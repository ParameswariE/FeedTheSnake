...
//    saveScoreToDatabase(playerName, score);
    ...
    fetchLeaderboardFromLocalStorage();
...
function saveScoreToLocalStorage(playerName, score) {
    const leaderboardKey = "snakeGameLeaderboard";

    // Retrieve the existing leaderboard or initialize it
    ...
    console.log("Top 10 leaderboard updated locally:", top10);

    // Refresh the displayed leaderboard
    fetchLeaderboardFromLocalStorage();
}

function fetchLeaderboardFromLocalStorage() {
    const leaderboardKey = "snakeGameLeaderboard";
    ...
    console.log("Leaderboard fetched and displayed:", leaderboardData);
}
